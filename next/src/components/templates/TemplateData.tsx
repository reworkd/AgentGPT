import {
    FaRegNewspaper, FaLaptopCode, FaPlaneDeparture, FaHashtag, 
    FaRegEnvelope, FaFileAlt, FaBookOpen, FaAppleAlt, FaDumbbell,
    FaChartLine, FaMoneyBillWave, FaBookReader, FaCalendarAlt, 
    FaBlog, FaGamepad, FaGlobeEurope, FaGraduationCap
  } from 'react-icons/fa';
  ...
  export const TEMPLATE_DATA: TemplateModel[] = [
    ...
    },
    {
      ...
      promptTemplate: "Create a caption and hashtags for a social media post about 'Summer Vacation'.",
