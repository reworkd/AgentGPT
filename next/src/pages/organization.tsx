            ...
            <div className="flex justify-center items-center w-full h-screen bg-zinc-900">
                <div className="max-w-4xl w-full font-sans justify-starts">
                    <div className="border-b p-4 my-2 border-white/10">
                        <h1 className="text-5xl mb-4 tracking-wide font-semibold text-white">Organization</h1>
                        <span className="text-sm text-white/50">Manage your Organization settings</span>
                    </div>
                    <div className=" border-b border-white/10 p-4 mb-2">
                        <h2 className="text-2xl text-white">Logo</h2>
                        <div className="w-20 h-20 rounded-lg bg-white my-4"></div>
                        <span className="text-white/50 text-sm">Pick a logo for your Oraganization</span>
                    </div>
