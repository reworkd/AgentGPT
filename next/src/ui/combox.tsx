  ...
  return (
    <Combobox as="div" value={props.value} onChange={props.onChange}>
      ...
      <div className="relative mt-1">
        ...
        {filtered.length > 0 && (
          <Combobox.Options className="background-color-4 text-color-primary absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
            {filtered.map((e, i) => (
              <Combobox.Option
                key={i}
                value={e}
