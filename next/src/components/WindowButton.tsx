...
const WindowButton = ({ ping, onClick, icon, text, border }: WindowButtonProps) => {
  return (
    <div
      className={clsx(
        "background-color-2 hover:background-color-5 relative flex h-8 cursor-pointer items-center gap-2 rounded-lg p-2 font-mono text-sm font-bold text-slate-12 transition-all",
