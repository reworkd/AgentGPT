...
def test_extract_tasks_no_completed_tasks():
...
def test_extract_tasks_with_completed_tasks():
    input_text = '["Task 1: Task one", "Task 2: Task two", "Task 3: Task three"]'
...
def test_extract_tasks_only_completed_tasks():
    input_text = '["Task 1: Task one", "Task 2: Task two", "Task 3: Task three"]'
...
def test_extract_tasks_empty_input():
    input_text = '[]'
    completed_tasks = []
    output = extract_tasks(input_text, completed_tasks)
    expected_output = []
...
def test_extract_tasks_no_valid_tasks():
