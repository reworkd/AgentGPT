  ...
  return (
    <div id="title" className="relative flex flex-col items-center">
      <div className="flex flex-row items-start">
        <span className="text-4xl font-bold text-slate-12 xs:text-5xl sm:text-6xl">Agent</span>
        <span className="text-4xl font-bold text-slate-9 xs:text-5xl sm:text-6xl">GPT</span>
        <PopIn delay={0.5}>
